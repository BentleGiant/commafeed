...
docker pull ghcr.io/bentlegiant/commafeed:master-postgresql-jvm

# Other database variants
docker pull ghcr.io/bentlegiant/commafeed:master-h2-jvm
docker pull ghcr.io/bentlegiant/commafeed:master-mysql-jvm
docker pull ghcr.io/bentlegiant/commafeed:master-mariadb-jvm
```
...
services:
  commafeed:
    image: ghcr.io/bentlegiant/commafeed:master-postgresql-jvm
